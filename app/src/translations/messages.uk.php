...
[
    ...
    'error_401'                  => '401 помилка. Доступ заборонено. Несанкційонований доступ.',
    ...
    'general_registration'       => 'Зареєстровано успішно. Тепер можете увійти! :)',
    ...
    'errors_' . \App\lib\consts::ERROR_CODE_USER_REGISTRATION_DUPLICATE_NICKNAME_OR_EMAIL   => 'Помилка. Користувач із таким NICKNAME або із такою поштою вже зараєстрований в системі.',
